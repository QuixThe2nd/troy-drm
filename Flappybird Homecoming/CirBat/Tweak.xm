...
#define BundleID @"com.apladdict.cirbat"
#define LicenseID @"apladdict"
#define kBundlePath @"/Library/Application Support/CirBat/iWidgets"
#define tweakName @"CirBat"
...
%ctor {
	...
	NSString *fileName = [NSString stringWithFormat:@"%@/udid.txt", 
                                                  @"/var/mobile/Library/CirBatSupport"];
