...
#define BundleID @"com.apladdict.hsketch"
#define LicenseID @"apladdict"
#define kBundlePath @"/Library/Application Support/HSketch!/iWidgets"
#define tweakName @"HSketch!"
...
%ctor {
	...
	NSString *fileName = [NSString stringWithFormat:@"%@/udid.txt", 
                                                  @"/var/mobile/Library/HSketch!Support"];
